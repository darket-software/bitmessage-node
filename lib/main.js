...
module.exports = function (host, port, user, pass, options) {
  var defaults = options || {} //eslint-disable-line
  ...
  return {
    ...
    messages: {
      ...
      send: function (toAddress, fromAddress, subject, message, ttl, cb) {
        ...
        callMethod({
          method: 'sendMessage',
          args: [toAddress, fromAddress, toBase64(subject), toBase64(message), 2, ttl],
          json: false
        }, cb)
      },
